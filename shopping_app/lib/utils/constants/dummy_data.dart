...
import 'package:shopping_app/features/shop/models/product_attribute_model.dart';
...
import 'package:shopping_app/features/shop/models/promo_code_model.dart';
...
class UDummyData {
  ...
  static final List<BrandModel> brands = [
    BrandModel(
      id: '1',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516213/Brands%20Images/ailedvpsqb70aksqmpvl.png',
      name: 'Nike',
      productsCount: 6,
      isFeatured: true,
    ),
    BrandModel(
      id: '2',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516214/Brands%20Images/hdhwq9gufgvztcfsxl0x.jpg',
      name: 'Adidas',
      productsCount: 7,
      isFeatured: true,
    ),
    BrandModel(
      id: '3',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516216/Brands%20Images/kh1ccluzechelzebtykb.jpg',
      name: 'Apple',
      productsCount: 6,
      isFeatured: true,
    ),
    BrandModel(
      id: '4',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516216/Brands%20Images/supibwaakj9xxfv0y9zf.png',
      name: 'Bata',
      productsCount: 1,
      isFeatured: true,
    ),
    BrandModel(
      id: '5',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516218/Brands%20Images/l6h7eecwdlcdjdwmjnoz.png',
      name: 'Bloody',
      productsCount: 4,
      isFeatured: false,
    ),
    BrandModel(
      id: '6',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516219/Brands%20Images/dksu5yxtu1d9okmlltia.jpg',
      name: 'Breakout',
      productsCount: 3,
      isFeatured: true,
    ),
    BrandModel(
      id: '7',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516220/Brands%20Images/ovyi37cgzdiz9elcufpl.png',
      name: 'Dari Mooch',
      productsCount: 3,
      isFeatured: true,
    ),
    BrandModel(
      id: '8',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516221/Brands%20Images/f2uh5bbuidjjjvqjo8rf.jpg',
      name: 'Interwood',
      productsCount: 5,
      isFeatured: true,
    ),
    BrandModel(
      id: '9',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516222/Brands%20Images/le9palocgew4psfp4pzn.jpg',
      name: 'HP',
      productsCount: 7,
      isFeatured: false,
    ),
    BrandModel(
      id: '10',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516223/Brands%20Images/zbxt2rgjhd9d8xjnc6cv.png',
      name: 'J.',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '11',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516224/Brands%20Images/uqlcki7kyl14ishdfh1i.png',
      name: 'NDURE',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '12',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516225/Brands%20Images/yyzi7prpaebvdhbwedfm.jpg',
      name: 'NorthStar',
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '13',
      image: 'https://res.cloudinary.com/inczy3d3/image/upload/v1786516226/Brands%20Images/qtsfbjnpzcrjd3hmazi1.png',
      name: 'Polo',
      productsCount: 2,
      isFeatured: true,
    ),
